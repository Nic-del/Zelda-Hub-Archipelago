...
function refreshFromArchipelago(server, slot, password, autoConnect) {
    try {
        localSettings.apServer = server;
        localSettings.apSlot = slot;
        localSettings.apPassword = password;
        localSettings.autoConnectAp = autoConnect;
...
function showArchipelagoModal() {
    ...
    document.getElementById('apAutoConnect').checked = localSettings.autoConnectAp;

ITEM_MAPPING_OLD={
    ["0.2.0"] = {
        ...
        [18432] = {{ "spinattack","spin_0.2.0" },{ "sevenscrolls","consumable" }},
        [19712] = {{ "greatspin","spin_0.2.0" },{ "sevenscrolls","consumable" }},

        [29696] = {{ "fastsplit","spin_0.2.0" },{ "sevenscrolls","consumable" }},
        [29440] = {{ "fastspin","spin_0.2.0" },{ "sevenscrolls","consumable" }},
        [29952] = {{ "longspin","spin_0.2.0" },{ "sevenscrolls","consumable" }},
